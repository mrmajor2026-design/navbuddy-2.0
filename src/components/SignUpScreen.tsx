...
export default function SignUpScreen({ onBack, onLogin, onSignUpSuccess }: SignUpScreenProps) {
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans text-[#1A2B3C]">
      ...
      <main className="flex-1 px-6 py-8 flex flex-col max-w-md mx-auto w-full">
        ...
        >
          ...
          <p className="text-[#64748B]">Join the community of modern travelers</p>
        </motion.div>

        {/* Form */}
        <div className="space-y-6">
          <div className="space-y-2">
            <label className="text-sm font-semibold text-[#0F172A] ml-1">Full Name</label>
            <input 
              type="text" 
